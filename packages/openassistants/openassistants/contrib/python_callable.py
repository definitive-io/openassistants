...
from openassistants.functions.base import BaseFunction, BaseFunctionEntityConfig, FunctionExecutionDependency
...
class PythonCallableFunction(BaseFunction):
    ...
    get_entity_configs_callable: Callable[[], Awaitable[dict[str, BaseFunctionEntityConfig]]]
